...
from randomizer.generation.state_controller import (
    GenerationSettings, disabled_enemy_scaling_settings,
)
...
class StateController(GenerationSettings):
    ...
    def randomizer_launch_active(self):
        """Return whether a standard Randomizer seed is available to launch."""
    ...
    def save_settings_file(self):
        ...
        path = filedialog.asksaveasfilename(
            ...
            initialfile='DTA Randomizer Settings.json',
            filetypes=(
