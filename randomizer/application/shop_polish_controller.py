...
class ShopPolishController(ShopArchipelagoController):
    ...
    def _free_buff_token_available(self, entry):
        ...
        return run.free_buff_tokens_used_stage < capacity
    ...
    def refresh_shop_catalogue(self, *_args):
        ...
        if (
            run is not None
            and modifier_values['cross_faction_power_offers']
        ):
        ...
        if run is not None and access_category and not owned_view:
            ...
            if (
                ...
                and self._shop_entry_available(locked_entry, run, stock=True)
                and modifier_allows_shop_offer(
                    locked_entry,
    ...
    def show_shop_offers(self):
        self.shop_catalogue_back_button.configure(text='Back to All Offers')
    ...
    def _shop_upgrade_effect_text(self, upgrade_id, definition):
        ...
        templates = {
            ...
            'expanded_loadout': (
                ...
                'permanent unit or power slots to the starting loadout.'
            ),
            'emergency_revival': (
            ...
            'free_buff_token': (
                ...
                'free current-run Shop buff purchase for every stage. '
    ...
    def _refresh_shop_history(self):
        ...
        if self.shop_run is not None:
            for stage, code in enumerate(
                ...
                tree.insert(
                    '', 'end',
                    values=(stage, mission.get('title') or code),
                )
