...
class WindowController:
    ...
    def sync_debug_completion_controls(self):
        """Keep Shop developer override hidden inside expanded launcher log."""
    ...
    def show_busy(self, title, detail='Please wait.'):
        ...
        # ``wait`` while X11 commonly provides ``watch``.
    ...
    def layout_settings_sections(self, width):
        ...
        if shop_mode:
            ...
            self.shop_settings_frame.grid(row=0, column=0, sticky='new')
