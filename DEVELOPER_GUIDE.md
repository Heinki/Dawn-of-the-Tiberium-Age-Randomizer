...
- `configs/missions.json`: mission classifications and campaign policy, including bonus-map metadata.
...
- Keep all installed mission codes explicitly classified, including configured bonus missions absent from `Battle.ini`.
