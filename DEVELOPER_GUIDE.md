...
> This guide originated upstream. Use [README.md](README.md), [DTA_PORTING_ANALYSIS.md](DTA_PORTING_ANALYSIS.md), and [DTA_BUFF_POLICY.md](DTA_BUFF_POLICY.md) for active DTA paths and safety rules.
