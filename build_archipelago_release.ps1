...
$launcherPath = Join-Path $outputPath "DTARandomizer.exe"
$apworldPath = Join-Path $outputPath "dta.apworld"
$setupPath = Join-Path $outputPath "DTARandomizer-Archipelago-Setup.md"
...
$payloadFiles = @(
    "DTARandomizer.exe",
    "dta.apworld",
    "DTARandomizer-Archipelago-Setup.md"
)
