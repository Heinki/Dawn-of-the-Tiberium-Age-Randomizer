"""Generated catalogue loader for the Dawn of the Tiberium Age APWorld."""
...
VICTORY_EVENT = "Dawn of the Tiberium Age Victory"
...
SHOP_PROGRESS_LOCATION_ID_BASE = 0x4DFE300
...
SHOP_STAGE_LOGIC_DATA = {
    index: {
        "item_name": f"Dawn of the Tiberium Age Shop Stage Victory: {index}",
