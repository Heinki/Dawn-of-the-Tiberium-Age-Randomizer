...
- Adds unit-specific production-clone buffs where the installed DTA rules support them: production, cost, speed, armor, health, damage, reload, range, blast area, sight, ammo, passenger capacity, cloaking, sensors, full-health regeneration, opportunity fire, and amphibious movement. Native capabilities are not offered redundantly except regeneration, whose Vinifera rate, step, and 100% cap can upgrade natural self-healers too.
