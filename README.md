...
- Exposes 128 canonical mobile types: 27 infantry, 93 vehicles/naval units, and 8 aircraft. The 121 non-essential types, including all four MCVs, can become access rewards. Engineer, both resource harvesters, and all four faction hovercraft transports remain permanently available.
